...
const useCountdown = ({
    ...
    // status
    const [status, setStatus] = useState<CountdownStatus>(CountdownStatus.Inactive)
    ...
    const pause = (): void => {
        if (status === CountdownStatus.Paused || status === CountdownStatus.Inactive) {
            return
        }
    ...
    const countdown: Countdown = {
        ...
        isActive : status === CountdownStatus.Running || status === CountdownStatus.Paused,
